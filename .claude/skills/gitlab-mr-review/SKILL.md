...
- Flag hardcoded values (URLs, tokens, names) that duplicate an already-defined variable in the same file. Suggest replacing with the existing variable as a nit.
