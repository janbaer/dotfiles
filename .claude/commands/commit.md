...
5. Show the generated message to the user in a code block. If `-y` was passed, skip the confirmation prompt and proceed directly to step 6. Otherwise say: "Here's the proposed commit message. Do you want to continue?"
6. If the user wants to continue (or `-y` was passed), run `git commit`
