...
Before drafting a skill, slash command, or subagent definition, decide which language it is written in:
...
Stay consistent within a single file — don't mix half German, half English. This applies to the SKILL.md / command.md / agent.md prose, the frontmatter description, and any inline examples; code blocks and shell commands stay literal regardless. If you're unsure which bucket a new skill falls into, ask Jan before drafting.
